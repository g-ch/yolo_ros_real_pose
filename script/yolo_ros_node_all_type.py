...
device_set = "MYRIAD"  #CPU, GPU, FPGA, HDDL or MYRIAD. Note GPU only supports intel GPU
input_set = "ROS"
...
depth_image_topic = "/iris/vi_sensor/camera_depth/depth/disparity" #"/camera/aligned_depth_to_color/image_raw"
...
motor_yaw_syncronize = False # if set true, you may need a fake publisher when running test: "rostopic pub -r 50 /place_velocity_info geometry_msgs/Point32 0.3 0.3 0.3"
